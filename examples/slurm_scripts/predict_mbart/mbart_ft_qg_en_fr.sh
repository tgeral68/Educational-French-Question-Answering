...
srun python -m examples.scripts.mbart_pred_qg --from-checkpoint $EFQALOG/mbart_ft_qg_en_fr/version_0/checkpoints/val-rouge-checkpoint-epoch=04-val_rouge=0.00.ckpt --test-dataset-folder $EFQADATA/test_dataset --batch-size 16
