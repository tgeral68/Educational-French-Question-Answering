...
srun python -m examples.scripts.mbart_pred_qg --from-checkpoint $EFQALOG/mbart_ft_qg_en_fr_alignement/version_1/checkpoints/val-rouge-checkpoint-epoch=09-val_rouge=0.00.ckpt --test-dataset-folder $EFQADATA/test_dataset --batch-size 16
