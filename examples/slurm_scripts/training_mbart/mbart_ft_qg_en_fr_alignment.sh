...
if [ -z "$1" ]
    then
        ...
        srun python -m examples.scripts.mbart_ft_qg --early-stopping-criterion sacrebleu --name mbart_ft_qg_en_fr_alignement --training-set fquad-fr-en.pb.json fquad-fr-fr.pb.json squad-en-en.pb.json squad-en-fr.pb.json piaf-fr-fr.pb.json piaf-fr-en.pb.json  --validation-set fquad-fr-fr.pb.json piaf-fr-fr.pb.json --resume-from-checkpoint $1
fi
